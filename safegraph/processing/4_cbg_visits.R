...
home_panel <- read.csv("home_panel_summary/home_panel_comb.csv")
...
#state <- state[-which(state %in% c("AS","AK", "AL", "AR","AZ","CA", "CO", 
#                                   "CT","DC", "DE","GU","HI", "IA","ID","KS","KY",
#                                   "LA","MA","MD","FL","TX","NY","IL","GA","OH","MI",
#                                   "PA","NC","MO","IN"))]
